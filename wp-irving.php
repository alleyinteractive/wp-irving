...
require_once WP_IRVING_PATH . '/inc/components/class-disqus.php';
...
require_once WP_IRVING_PATH . '/inc/components/class-pagination-link.php';
require_once WP_IRVING_PATH . '/inc/components/class-paginator.php';
require_once WP_IRVING_PATH . '/inc/components/class-parsely.php';
